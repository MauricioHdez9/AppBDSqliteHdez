...
public class MainActivity extends AppCompatActivity {
    ...
    public EditText etCodigo,etDescripcion,etUbicion,etExistencia ;
    //public TextView;
    public Button btnAlta,btnConsulta,btnEliminar,btnEditar,btnAbrirListaProd;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        //integracion de el java xml
        etCodigo=findViewById(R.id.etCodigo);
        etDescripcion=findViewById(R.id.etDescripcion );
        etUbicion=findViewById(R.id.etUbicion);
        etExistencia=findViewById(R.id.etExistencia);

        btnAbrirListaProd=findViewById(R.id.btnAbrirListaProd);
        btnAbrirListaProd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent abrirVentanaListaProd= new Intent(view.getContext(),ListaProductos.class);
                startActivityForResult(abrirVentanaListaProd ,0);
    ...
    //metodos para alta  de productos
    ...
    public void altaProducto(View view) {
        ...
        String Ubicacion = etUbicion.getText().toString();
...
//Cursor recorre los campos d euna tabla hasta encontralo por campo distintivo
        ...
        if(fila.moveToFirst()){//si condicion es verdadera, es decir, encontro un campo y sus datos
            ...
            etUbicion.setText(fila.getString(1));
